...
Route::get('user-data', [UserController::class, 'getUser'])->middleware('\App\Http\Middleware\BasicUserAuth')->middleware('\App\Http\Middleware\CorsMiddleware');  // Ruta para obtener los datos de un usuario
