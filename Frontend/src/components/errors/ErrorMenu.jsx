...
const ErrorMenu = ({text, buttonText, openError, closeError}) => {
  ...
  const navigate = useNavigate(); // Hook de navegación
    ...
    useEffect(() => {
      // Lógica para abrir el modal dependiendo de alguna condición
      setIsModalOpen(true);
