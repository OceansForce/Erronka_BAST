    ...
    <>
      <div className="flex justify-center m-5">
        <button
          ...
          className="block text-black dark:text-white bg-red-500 hover:bg-red-600 transition-colors focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
          type="button"
        >
          {t('userProfile:deleteButtom')}
        </button>
      </div>
